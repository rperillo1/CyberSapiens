...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
            authority: 'https://csapienplayers.b2clogin.com/csapienplayers.onmicrosoft.com/B2C_1_SignUpSignIn_1',
        },
        // forgotPassword: {
...
export const msalB2CConfig = {
    auth: {
        clientId: '3bdf6746-06b8-4085-9c62-0d69577dbf15', // This is the ONLY mandatory field that you need to supply.
